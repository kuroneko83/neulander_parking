...
description: Read-only application security reviewer. Use PROACTIVELY after changes to authentication, authorization/RBAC, tenant scoping, payments/webhooks, file uploads/exports, personal data handling (LGPD), or infrastructure/IAM, and at the end of phases 1, 5 and 10.
